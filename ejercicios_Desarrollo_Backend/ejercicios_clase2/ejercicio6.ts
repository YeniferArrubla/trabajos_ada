...
// nombre (string), edad (number), y pais (string). La función debe devolver un objeto que tenga esas propiedades. 
...
console.log(crearPersona('Analía', 34, 'Perú'));

// or: with explicit return type and without the temporary variable
