...
console.log(`Este es el valor de PI: ${PI} mostrado desde una exportación directa`);
console.log(`Este es el valor de E: ${E} mostrado desde una exportación separada`);