...
rl.question('Ingresa el primer número a sumar: ', (userAnswer1) => {
    rl.question('Ingrese el segundo número a sumar: ', (userAnswer2) => {
        const sum = Number(userAnswer1) + Number(userAnswer2);
        console.log(`${userAnswer1} + ${userAnswer2} = ${sum}`)
        rl.close();
    });
});
