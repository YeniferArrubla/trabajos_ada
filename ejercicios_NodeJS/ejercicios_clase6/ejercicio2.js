...
// Consigna: En este ejercicio, escribirás un programa que muestre información útil sobre el entorno donde se está ejecutando el programa. 
// Este ejercicio te ayudará a practicar los métodos del objeto process en Node.js.
...
console.log(`- La plataforma de ejecución de Node.js es: ${platform} 
- El directorio de trabajo actual es ${cwd}`);