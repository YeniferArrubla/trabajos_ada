...
const dollars = rlSync.questionFloat('Ingresa la cantidad en dólares: ');

const euros = dollars * 0.85;

console.log(`${dollars} dólares equivalen a ${euros.toFixed(2)} euros`); //toFixed(2) Muestra 2 decimales
