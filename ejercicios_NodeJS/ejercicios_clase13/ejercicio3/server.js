...
// Consigna:
// Implementar un sistema de gestión de películas donde el cliente pueda solicitar 
// información sobre una película específica a través de su título.
// El servidor procesará la solicitud, buscará la película en una base de datos simulada (archivo JSON) y devolverá la información al cliente.
// Pasos a seguir:
// 1. Servidor TCP:
// o El servidor debe escuchar en el puerto 4002.
// o Debe recibir solicitudes del cliente que incluyan el título de una película.
...
// 2. Cliente TCP:
// o El cliente debe conectarse al servidor y enviar el título de una película.
// o Debe recibir la respuesta del servidor y mostrarla en la consola.
// o El cliente debe permitir al usuario ingresar el título de la película que desea consultar.
